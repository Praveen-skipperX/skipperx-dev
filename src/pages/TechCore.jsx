...
import nineeight from "../assets/91.png";
import nineseven from "../assets/98.png";
...
import p6l from '../assets/velocity8.png';
    ...
    <section className="startup-section">
      <div className="startup-container">
        ...
        <h1 className="startup-title">
          Everything to Help You Learn Tech and Get<br></br> Ahead —  <span className="highlightstack">Tech Core  </span>has you Covered
        </h1>

        
        <p className="startup-subtitle">
          12+ Real-World Tech Programs to Get You Job-Ready
        </p>

        
        <div className="startup-buttons">
          <button className="category-btn">Code</button>
          <button className="category-btn">Innovate</button>
          <button className="category-btn">Thrive</button>
        </div>
       ...
       {/* Roadmap Section */}
        ...
        <div className="roadmap-container">
            ...
            <img src={techroadmap} alt="Bulb Icon" className="roadmap-image" />
        </div>
        <div className="roadmap-container-mobile">

          <img src={techroadmapmobile} alt="Bulb Icon" className="roadmap-image-mobile" />
        </div>
        </section>
      ...
      <section className="startup-info-section" ref={sectionRef}>
          <div className="startup-info-left">
            ...
            <p className="startup-info-para">
              Develop practical skills to design, build, and secure next-generation systems.
            </p>  
            ...
            <p className="startup-info-para-poins">
               • Create secure networks in Cyber Security.
            </p>
            <p className="startup-info-para-poins">
               • Develop scalable web experiences and cloud platforms.
            </p>
            <p className="startup-info-para-poins">
               • Work with emerging fields like IoT, Robotics, Embedded Systems, Hybrid & Electric Vehicles, and Auto CAD.
            </p>
            <p className="startup-info-para-poins">
              • Combine technical expertise with digital marketing to accelerate impact.
            </p>
          ...
          <div className="drone-info-right desktop-only" ref={desktopFormRef}>
            {!showForm ? (
              ...
              >
                <h2>Master Tech Core Program</h2>
                ...
                <div className="drone-price-section">
                  ...
                  <div className="drone-current-price">₹12,000</div>
                </div>
        ...
        <section class="startup-walk-away">
          ...
          <div class="startup-walk-away-cards">
            <div class="startup-walk-card">
              ...
              <p>Build real project in coding,  <b>cybersecurity, AI, Design and more</b></p>
            </div>

            <div class="startup-walk-card">
              <div class="startup-icon">⚡</div>
              <p>Learn top tools like   <b>Figma, Python and google cloud</b></p>
            </div>

            <div class="startup-walk-card">
              <div class="startup-icon">⚡</div>
              <p>Explore new tech -  <b>robots, electric vehicle and smart devices</b></p>
            </div>

            <div class="startup-walk-card">
              <div class="startup-icon">⚡</div>
              <p>Train for real jobs with  <b>mentors, internships, and hands-on practice </b></p>
            </div>
          </div>
        </section>
